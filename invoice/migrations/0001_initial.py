    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invoiceNumber', models.CharField(unique=True, max_length=64, verbose_name='invoice number', db_index=True)),
                ('invoiceAmount', models.PositiveIntegerField(verbose_name='invoice amount')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.FileField(upload_to=b'invoice_templates', null=True, verbose_name='Invoice template file', blank=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AddField(
            model_name='invoice',
            name='template',
            field=models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='Template to use for this invoice', to='invoice.InvoiceTemplate', null=True),
