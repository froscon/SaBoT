    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ownerId', models.PositiveIntegerField(verbose_name='Key of the owner object', null=True, editable=False, blank=True)),
                ('createDate', models.DateField(auto_now_add=True, verbose_name='Creation date')),
