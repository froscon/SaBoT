...
urlpatterns = [
	re_path('^token/(?P<token>[0-9a-z]+)$', TokenLoginView.as_view(), name="auth_token"),
	path('profile', login_required(UserProfileView.as_view()), name="auth_user_profile"),
	re_path('^activatepw/(?P<activation_key>[^/]+)/?$', ActivateAndSetPWView.as_view(), name="auth_activate_pw"),
