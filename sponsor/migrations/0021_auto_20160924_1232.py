    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailTemplateName', models.CharField(max_length=128, verbose_name='Mail template name')),
                ...
                ('template', models.ForeignKey(on_delete=django.db.models.deletion.SET_NULL, verbose_name='Mail text template', to='sponsor.SponsorMailTemplate', null=True)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.AlterField(
            ...
            name='name',
            field=models.CharField(max_length=128, verbose_name='Displayed attachment file name'),
